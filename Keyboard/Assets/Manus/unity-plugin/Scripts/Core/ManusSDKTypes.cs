...
namespace Manus
{
    public partial class CoreSDK
    {
        ...
        /// <summary>Used to tell what severity the log is</summary>
        ...
        public enum SetGloveCalibrationReturnCode
        {
            Error = 0,
            Success = 1,
            VersionError = 2,
        ...
        public const int RAWDEVICEDATA_SENSORDATA_ARRAY_SIZE = 5;
        ...
        public struct RawDeviceData
        {
            ...
            public ManusTransform[] sensorData;
            public ManusQuaternion rotation;

            public RawDeviceData(uint p_Id,uint p_SensorCount,ManusTransform[] p_SensorData,ManusQuaternion p_Rotation)
            {
                id = p_Id;
        ...
        [System.Serializable]
        [StructLayout(LayoutKind.Sequential)]
        public struct RawDeviceDataInfo
        {
            public ManusTimestamp publishTime;
            public uint rawDeviceDataCount;

            public RawDeviceDataInfo(ManusTimestamp p_PublishTime,uint p_RawDeviceDataCount)
            {
                publishTime = p_PublishTime;
                rawDeviceDataCount = p_RawDeviceDataCount;
            }
        }
        ...
        public const int USERLANDSCAPE_USERS_ARRAY_SIZE = 16;
        ...
        {
            public uint maxGlovePairs;
            [MarshalAs( UnmanagedType.I1 )]
            public bool recording;
            [MarshalAs( UnmanagedType.I1 )]
            public bool exporting;
            [MarshalAs( UnmanagedType.I1 )]
            public bool advancedExporting;
            [MarshalAs( UnmanagedType.I1 )]
            public bool unitySession;
            [MarshalAs( UnmanagedType.I1 )]
            public bool unrealSession;
            [MarshalAs( UnmanagedType.I1 )]
            public bool openXRSession;
            [MarshalAs( UnmanagedType.I1 )]
            public bool sdk;
            [MarshalAs( UnmanagedType.I1 )]
            public bool raw;
            ...
            [MarshalAs( UnmanagedType.I1 )]
            public bool viconSession;
            [MarshalAs( UnmanagedType.I1 )]
            public bool nokovSession;
            [MarshalAs( UnmanagedType.I1 )]
            public bool icidoSession;
            [MarshalAs( UnmanagedType.I1 )]
            public bool siemensSession;
            [MarshalAs( UnmanagedType.I1 )]
            public bool vredSession;
            [MarshalAs( UnmanagedType.I1 )]
            public bool integrated;
            [MarshalAs( UnmanagedType.I1 )]
            public bool cortexSession;
            [MarshalAs( UnmanagedType.I1 )]
            public bool fzMotionSession;
            [MarshalAs( UnmanagedType.I1 )]
            ...
            public LicenseInfo(uint p_MaxGlovePairs,bool p_Recording,bool p_Exporting,bool p_AdvancedExporting,bool p_UnitySession,bool p_UnrealSession,bool p_OpenXRSession,bool p_Sdk,bool p_Raw,bool p_MobuSession,bool p_XsensSession,bool p_OptitrackSession,bool p_QualisysSession,bool p_ViconSession,bool p_NokovSession,bool p_IcidoSession,bool p_SiemensSession,bool p_VredSession,bool p_Integrated,bool p_CortexSession,bool p_FzMotionSession,bool p_WorldVizSession,bool p_NoraxonSession)
            {
                ...
                exporting = p_Exporting;
                advancedExporting = p_AdvancedExporting;
                unitySession = p_UnitySession;
                unrealSession = p_UnrealSession;
                openXRSession = p_OpenXRSession;
                sdk = p_Sdk;
                raw = p_Raw;
                ...
                viconSession = p_ViconSession;
                nokovSession = p_NokovSession;
                icidoSession = p_IcidoSession;
                siemensSession = p_SiemensSession;
                vredSession = p_VredSession;
                integrated = p_Integrated;
                cortexSession = p_CortexSession;
        ...
        [System.Serializable]
        [StructLayout(LayoutKind.Sequential)]
        public struct GloveCalibrationArgs
        {
            public uint gloveId;

            public GloveCalibrationArgs(uint p_GloveId)
            {
                gloveId = p_GloveId;
            }
        }
        ...
        [System.Serializable]
        [StructLayout(LayoutKind.Sequential)]
        public struct GloveCalibrationStepArgs
        {
            public uint gloveId;
            public uint stepIndex;

            public GloveCalibrationStepArgs(uint p_GloveId,uint p_StepIndex)
            {
                gloveId = p_GloveId;
                stepIndex = p_StepIndex;
            }
        }

        /// <summary>
        /// <para>Stores the data associated to a single calibration step for a specific glove.</para>
        /// <para>if the time value is negative, it means that its a continuous step and the value is estimated</para>
        /// </summary>
        [System.Serializable]
        [StructLayout(LayoutKind.Sequential)]
        public struct GloveCalibrationStepData
        {
            public uint index;
            [MarshalAs( UnmanagedType.ByValTStr, SizeConst = 64 )]
            public string title;
            ...
            public GloveCalibrationStepData(uint p_Index,string p_Title,string p_Description,float p_Time)
            {
                index = p_Index;
                title = p_Title;
